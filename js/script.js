window.onload = function () {
  ...
  gui.add(ball, 'rotationX').min(-0.05).max(0.05).step(0.001);
  gui.add(ball, 'rotationY').min(-0.05).max(0.05).step(0.001);
  gui.add(ball, 'rotationZ').min(-0.05).max(0.05).step(0.001);
